defmodule Bmx01.Repo.Migrations.BaseMigration do
  ...
  def change do
    ...
    add :type      , :string        # Tracker::BugZilla, Tracker::GitHub, Tracker::Cvrf
    add :uuid      , :string       
    add :name      , :string        # bugmark/exchange
    # add :xfields   , :hstore        ,  null: false, default: {}
    # add :jfields   , :jsonb         ,  null: false, default: {}
